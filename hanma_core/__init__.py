"""hanma_core — internal package for hanma.py.
...
# ── _THEMES_DIR: defined here so tests can monkey-patch hanma_core._THEMES_DIR
...
from hanma_core.highlight import HIGHLIGHT_CSS, _build_highlight_css
from hanma_core.parsing import (
...
from hanma_core.watch import (
    _HanmaEventHandler, _watch_polling, watch_and_rebuild, _WATCHDOG_AVAILABLE,
)
from hanma_core.scaffold import _SCAFFOLD_FILES, init_scaffold
from hanma_core.cli import main, _serve
...
def load_theme(name: str) -> tuple:
    ...
    hanma_core._THEMES_DIR and have load_theme() honour the patched value.
    """
